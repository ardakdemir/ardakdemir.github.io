...
- **NLP is in a submission crisis.** One keynote framed it as a “success catastrophe”: the field has grown faster than the reviewing system can handle, and no one seems to have a full solution. The review crisis is really a symptom of this bigger problem. See this [discussion of the ACL 2026 business meeting](https://www.linkedin.com/posts/nikos-aletras-6b797422_the-acl-2026-business-meeting-during-the-activity-7480159920043102208-eLHb?utm_source=share&utm_medium=member_desktop&rcm=ACoAABOiqN8BLg2C5pbHHEjJHpMXDOJLmZ7F1T4).
- **Build scaffolds, not just papers.** Codebases, datasets, workshops, and communities give future work something to build on. A single paper can produce a result; a community can build a field. This theme came up in both the explainability panel and the Big Picture invited talk.
- **Evaluation shapes what we build.** The presidential address made a strong case for treating evaluation as a measurement science, not as a final box to check. What we choose to measure ends up shaping what the field works on.
...
- **Research and engineering are getting harder to separate.** A discussion in the Careers in NLP panel highlighted that good researchers also need to be good engineers. They take ownership, unblock themselves, and get things done.
...
Two points from the presidential address really stuck with me. First, language should stay central to NLP research. Second, evaluation does not just report progress—it shapes progress by deciding what the community optimizes for.
...
The opening keynote described the submission crisis as a “success catastrophe.” NLP's growth is a success, but the scale has overwhelmed the systems the field depends on. The review crisis is not the root problem; it is the most visible symptom.

The talk also raised how hard it has become to tell ACL and EMNLP apart. ACL used to represent computational linguistics more broadly, while EMNLP had a clearer focus on empirical and statistical methods. Today, both are dominated by similar transformer-based work, and even NeurIPS and ICML can feel increasingly similar.

That is worrying because science needs people to try different paths, including paths that fail. One possible response raised in the talk was taking venue fit and the type of contribution more seriously during review.

Another uncomfortable point was the imbalance between publishing to advance human knowledge and publishing to get jobs at top industry labs. Right now, the incentives lean heavily toward the latter.

### Big Picture Workshop Invited Talk

The invited talk [“Where It Hurts: Finding Durable Questions While Moving Fast”](https://www.bigpictureworkshop.com/) used a trigger-point analogy for choosing research problems. The idea is not to chase every immediate pain point, but to find the places where focused work could unlock broader progress.

The talk contrasted two failure modes:
...
The useful middle ground is to find high-leverage pressure points: maybe an evaluation method everyone knows is limited but keeps using, or a dataset the field needs but no one has built.

### Careers in NLP Panel

One speaker had a very practical take on the blurry line between research and engineering. Successful researchers do not stop at ideas. They take ownership of the whole effort, build what they need, unblock themselves, and execute.
...
Below are a few papers that drew my attention and stuck with me after the conference.
